...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mViewHolder.textToday.setText("Hoje: " + SIMPLE_DATE_FORMAT.format(Calendar.getInstance().getTime()));
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.button_confirm) {
            ...
            /*Troque pelo valor da constante, mas não era esse o problema*/
            intent.putExtra(FimDeAnoConstants.PRESENCE, presence);

            /*App não iniciava a outra tela*/
    ...
    private void verifyPresence() {
        /*A key estava com valor errado, troquei pelo valor da constante na classe*/
        String presence = this.mSecurityPreferences.getStoredString(FimDeAnoConstants.PRESENCE);
        if (presence.equals(""))
